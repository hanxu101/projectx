...
{
    AddOneLine(true,false,true,true,false);
    AddOneLine(false,false,true,false,true);
    AddOneLine(false,false,true,false,true);
    AddOneLine(true,false,false,true,false);
    AddOneLine(false,true,true,false,true);
    AddOneLine(false,true,true,true,false);
    ...
    MMR_IMPLEMENT_STATE_BEGIN(MonsterGroupLogic, Activate)
{
    MMR_STATE_CONSTRUCTOR_BEGIN
    {
        ...
        schedule(schedule_selector(MonsterGroupLogic::MonsterLineWave), 0.5);
    }
    MMR_STATE_CONSTRUCTOR_END
